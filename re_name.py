...
def replace_names_in_file(file_path):
    ...
    replacements = {
        ...
        r'(?:迪俪|迪立|笛俪)': '迪丽',
        r'(?:肉|热)(?:芭|吧|巴)': '热巴',
        r'(?:范|樊)(?:彬彬|栤栤|兵兵|宾宾|水水|二冰|氷氷)': '范冰冰',
        r'冯恭': '冯巩',
        r'冯(?:小|晓|)(?:钢|刚)': '冯小刚',
        r'马大缸': '冯小刚',
        r'马思存': '马思纯',
        ...
        r'浏(?:楷崴)': '刘恺威',
        r'刘(?:佳玲)': '刘嘉玲',
        r'(?:刘|柳)(?:师师|施施|丝丝|思思|诗诗|司司|诗丝|小诗)': '刘诗诗',
        r'刘(淘|韬)': '刘涛',
        r'柳阿姨': '刘阿姨',
        r'柳茜': '刘亦菲',
        r'冷巴': '热巴',
        r'丽影': '丽颖',
        r'(?:刘|柳)(?:茜茜|亦菲|一非|一菲|依霏|逸妃|亦非|亦妃|依妃|艺妃|伊菲|依菲|艺菲|一霏|奕霏)': '刘亦菲',
        r'柳(?:颜|研|燕|妍)': '柳岩',
        r'卢(?:靖杉)': '卢靖姗',
        r'梁(?:超卫|朝维)': '梁朝伟',
        r'梁家(?:灰|慧)': '梁家辉',
        ...
        r'杨容': '杨蓉',
        r'杨樰': '杨雪',
        r'(?:一菲|亦非|伊菲|依菲|依妃|亦妃|艺菲|逸妃|艺妃|怡霏|一非|一霏|奕霏)': '亦菲',
        r'媛媛': '圆圆',
        r'润兒': '允儿',
        ...
        r'(?:张|章)(?:紫|梓|籽|姊)(?:菻|淋|琳|霖|啉)': '张梓琳',
        r'(?:张|章)(?:国|果|帼)(?:绒|融|荣|容|栄|榮)': '张国荣',
        r'章一山': '张一山',
        r'(?:张|章)(?:亿|一|易|益|影)(?:某|谋|謀)': '张艺谋',
        r'(?:章|张)(?:亿|艺|一|易|益|毅)(?:兴|星)': '张艺兴',
        r'(?:张|章)(?:子|紫|梓)(风|枫)': '张子枫',
        ...
        r'(?:张|章)(?:静仪)': '张婧仪',
        r'(?:章)(?:含韵)': '张含韵',
        r'(?:张|章)(?:紫怡|稀土|子义|紫怡|子怡|子衣|子意|紫衣)': '章子怡',
        r'赵(?:金麦|妗麦)': '赵今麦',
        r'赵(?:小|立|丽|莉|俪)(?:盈|骨|颖|影|盈|赢)': '赵丽颖',
        r'赵(?:璐司|路思|璐思)': '赵露思',
        r'赵(?:奔山|本三)': '赵本山',
        r'赵(?:微|遮天)': '赵薇',
        r'周(?:瑞发|润法)': '周润发',
